...
with col1:
    ...
    st.markdown("""
                ...
                En este repositorio se publica la información recopilada en los eventos de lluvia, y se proveen herramientas para la recopilación de la información y el despliegue de la misma en forma gráfica.
                """, )
